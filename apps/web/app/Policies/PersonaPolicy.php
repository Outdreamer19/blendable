...
class PersonaPolicy
{
    ...
    {
        return true; // Users can view personas in their workspace
    }
    ...
    {
        return $user->canAccessWorkspace($persona->workspace);
    }
    ...
    {
        return true; // Users can create personas in their workspace
    }
