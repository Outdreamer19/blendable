...
# Chat AI Integration Test Runner
# This script runs the Playwright tests for the chat functionality

echo "🚀 Starting Chat AI Integration Tests..."
echo "========================================"
...
# Run the specific chat tests
npx playwright test tests/e2e/ai-chat.spec.ts --headed --timeout=120000
